...
function submitCV() {
    ...
    $.get('/cvModel', function (data, status) {
        ...
        if (x == 0) {
            ...
            cv.heating.gasStaging.isUsed = true;
            cv.heating.gasStaging.points.stages = 1;
        } else if (x == 8) {
            cv.heating.gasStaging.isUsed = true;
            cv.heating.gasStaging.points.stages = 2;
        } else if (x == 9) {
            cv.heating.gasStaging.isUsed = true;
            cv.heating.gasStaging.points.stages = 3;
        } else if (x == 10) {
            cv.heating.gasStaging.isUsed = true;
            cv.heating.gasStaging.points.stages = 4;
        } else if (x == 11) {
            cv.heating.gasStaging.isUsed = true;
            cv.heating.gasStaging.points.stages = 5;
        } else if (x == 12) {
            cv.heating.gasStaging.isUsed = true;
            cv.heating.gasStaging.points.stages = 6;
        } else if (x == 13) {
