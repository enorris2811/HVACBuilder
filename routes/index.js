...
router.get('/overview/project/:project/unit/:unit',projectController.get_unit_overview);
...
router.get('/points/project/:project/unit/:unit',projectController.get_unit_points);
...
router.get('/options/project/:project/unit/:unit',projectController.get_unit_options);
...
router.get('/sequence/project/:project/unit/:unit',projectController.get_unit_sequence);
